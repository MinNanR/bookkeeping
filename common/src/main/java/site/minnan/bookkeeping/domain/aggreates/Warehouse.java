...
public class Warehouse {
    ...
    public static Warehouse of(String warehouseName, BigDecimal balance, Integer ledgerId) {
        return new Warehouse(null, warehouseName, balance, ledgerId, Timestamp.from(Instant.now()), null);
    }
