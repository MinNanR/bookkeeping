...
@Entity
@Table(name = "report_income_analysis_monthly")
@Getter
@AllArgsConstructor(access = AccessLevel.PRIVATE)
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class IncomeAnalysisMonthlyReport extends AbstractIncomeReport {
    ...
    public IncomeReportVO toIncomeReportVO() {
        return new IncomeReportVO(amount, StrUtil.format("{}年{}月", year, month));
    }
}
